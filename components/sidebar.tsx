    ...
    return (
        <div className="space-y-4 py-4 flex flex-col text-[#A1A1A1] h-full bg-[#09090B]">
                ...
                <div className="px-3 py-2 flex hover:opacity-80 transition-opacity duration-500">
                    <Link href="/dashboard" className="flex items-center pl-3">
                        <div className="relative w-10 h-10">
                            <Image fill alt="Valend.Ai" src="/logo.png"></Image>
                        </div>
            ...
            <div className="px-6 space-y-1">
                {routes.map((route) => (
                    <Link href={route.href} key={route.href} className={cn("text-sm group flex p-3 w-full justify-start font-medium cursor-pointer hover:text-white hover:shadow-white hover:shadow-[0_0px_5px_rgb(0,0,0,0.2)] hover:bg-white/10 rounded-lg transition",
